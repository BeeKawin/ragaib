...
class TestJudgeParser(unittest.TestCase):
    def test_parse_valid_json(self):
        raw = '{"correctness":5,"groundedness":4,"completeness":4,"clarity":5,"safety":5,"rationale":"Good answer"}'
    ...
    def test_parse_reject_invalid_score(self):
        raw = '{"correctness":0,"groundedness":4,"completeness":4,"clarity":5,"safety":5,"rationale":"Bad"}'
